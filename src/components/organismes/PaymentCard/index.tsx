  ...
  return (
    <div className=" w-full font-cabin bg-white rounded-xl">
      <div className=" w-[871px] p-4">
        <p className=" text-3xl uppercase tracking-[0.2em]">Payment Method</p>
        <div className=" flex pt-4 justify-between">
          <div className=" flex flex-col gap-2">
            <div className=" flex gap-2 items-center">
              ...
              <p className=" text-lg">
                Mastercard{" "}
                <span className=" text-[#60695C]">ending in 1252</span>
              </p>
            </div>
            <div className=" flex gap-2 items-start">
              ...
              <p className=" text-lg">
                $ 53.21
                <span className=" text-[#60695C]"> gift card balance</span>
              </p>
            </div>
            <div className=" flex gap-2 items-center">
              <svg
