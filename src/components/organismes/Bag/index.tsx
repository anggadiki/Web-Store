    ...
    <>
      <div className="">
        <div className=" pt-14 h-max absolute">
          <hr className=" h-screen border-4 rounded-lg border-[#1A1F1680]" />
        </div>
        ...
        <div className=" w-full flex justify-center mt-10">
          <button className=" bg-black text-white py-2 px-6 rounded-[14px] flex gap-2 justify-center items-center">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <p className=" font-cabin text-xl font-semibold">View Bag</p>
          </button>
        </div>
      </div>
    </>
