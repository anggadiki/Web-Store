...
const ItemBag = ({ src = "/product.png", title, color = "white" }: Props) => {
  return (
    <div className=" flex items-end bg-white px-6 py-4 rounded-3xl gap-4 font-cabin">
      <div className=" w-48 h-[254px] bg-white flex items-center">
        <Image
          src={src}
          alt="product"
          width={1091.36}
      ...
      <div className=" py-2">
        ...
        <p className=" text-xl text-[#60695C] pt-1">{color}</p>
        ...
        <div className=" flex justify-between pt-7 text-xl">
