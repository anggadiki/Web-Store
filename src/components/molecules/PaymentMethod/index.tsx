const PaymentMethod = () => {
  return (
    <div className=" w-[676px] font-cabin bg-white p-2 rounded-xl">
      <div className=" tracking-[0.2em] text-3xl p-4 uppercase">
        <p>Select a Card</p>
      </div>
      <div className=" p-2 pl-4 text-[#1A1F1680] text-lg flex items-center">
        <svg
          width="25"
          height="25"
          viewBox="0 0 24 24"
        ...
        <div className=" pl-2">MasterCard ending in 4242</div>
      </div>{" "}
      <div className=" p-2 pl-4 text-[#1A1F1680] text-lg flex items-center">
        <svg
          width="25"
        ...
        <div className=" pl-2">VISA Debit ending in 2894</div>
      </div>
    </div>
  );
};
